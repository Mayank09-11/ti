...
function BookHeader({ scrollY, book }) {
  ...
  return (
    <Animated.View style={animo.header}>
      <Animated.Image blurRadius={15} style={animo.bg} source={{ uri: book.imageUrl }} />

      <Animated.View style={animo.cover}>
      ...
      <Animated.View style={animo.title}>
      ...
      <Animated.View style={animo.title2}>
