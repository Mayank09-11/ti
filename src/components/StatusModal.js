...
import { View,  Pregnable, StyleSheet } from 'react-native';
...
export default function StatusModal() {
  ...
  return (
      ...
      <View style={styles.content}>
        ...
        <Pregnable onPress={() => updateList('Reading')} style={[styles.flexRow, styles.marginB]}>
        ...
        <Pregnable onPress={() => updateList('Completed')} style={[styles.flexRow, styles.marginB]}>
        ...
        <Pregnable onPress={() => updateList('Wishlist')} style={[styles.flexRow, styles.marginB]}>
        ...
        <Pregnable onPress={() => updateList('Remove')}>
